    ...
    <div class="layui-row">
        <form class="layui-form">
            <div class="layui-form-item">
                <label for="L_id" class="layui-form-label">用户id</label>
                <div class="layui-input-inline">
                    <input type="text" id="L_id" name="id" disabled="" value="${param.id}" class="layui-input"></div>
            </div>
            <!--                    <div class="layui-form-item">-->
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-form-mid layui-word-aux">8到20个字符</div></div>
            <div class="layui-form-item">
                <label for="L_repass" class="layui-form-label">
...
<script>layui.use(['form', 'layer'],
    function() {
        ...
        form.on('submit(save)',
            function(data) {
                console.log(data);
                $.post("/newsWeb/newPasswordServlet",{"id":data.field.id,"password":data.field.newpass},function (data) {
                    layer.msg(data);
                })
                //发异步，把数据提交给php
                layer.alert("修改成功", {
