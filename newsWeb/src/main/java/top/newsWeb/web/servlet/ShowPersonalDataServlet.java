...
/**
 * 显示用户详细信息到update.jsp页面中
 */
public class ShowPersonalDataServlet extends HttpServlet {
...
//            response.sendRedirect("/newsWeb/update.jsp");
            request.getRequestDispatcher("update.jsp").forward(request,response);
            System.out.println("转发至update.jsp");
        }
    }
